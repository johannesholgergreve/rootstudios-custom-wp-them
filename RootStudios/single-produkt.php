...
<div class="default2ColTextarea container">
	...
	<a href="<?php echo get_sub_field('produkt_oversigt_link'); ?>" class="productHeroBtn" style="background:#CCCCCC;"><?php echo get_field("default2content_btn_text");?></a>
...
<div class="singleProductContents">
	<div class="container">
		<div class="col-xs-12">
			<h3><?php echo get_field("product_details_heading");?></h3>	
		</div>
